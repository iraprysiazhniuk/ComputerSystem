...
namespace CS_lab2_1
{
    class Program
    {
        ...
        public static void multiplication(string num1, string num2) //метод множення
        {
            Int64 multiplicand, multiplier, product = 0, startMultiplicand, startMultiplier;
            startMultiplicand = multiplicand = Int32.Parse(num1); //перший множник
            startMultiplier = multiplier = Int32.Parse(num2); //другий множник
            for (int i = 0; i < 32; ++i)
            {
                ...
                short a = (short)(multiplier & 1); //найменший значущий біт

                if (a == 1)
                {
                    Console.WriteLine("Сумуємо multiplicand і product.\n");
                    product += multiplicand;
                }
                Console.WriteLine("Product:\n" + FinishStringWithZeros(Convert.ToString(product, 2)) + "\n");
                Console.WriteLine("Здвигаємо multiplicand вліво");
                Console.WriteLine("Здвигаємо multiplier вправо");
